...
describe('App', () => {
  ...
  it('opens the crafting planner, calculates RRR, and manages craft entries', () => {
    ...
    const bonusDialog = screen.getByRole('dialog', { name: 'Crafting Bonuses' });
    ...
    expect(within(bonusDialog).queryByRole('heading', { name: 'City Crafting Bonuses' })).not.toBeInTheDocument();
    expect(within(bonusDialog).getByRole('heading', { name: 'Cities' })).toBeInTheDocument();
    expect(within(bonusDialog).getByRole('heading', { name: 'Outlands' })).toBeInTheDocument();
    expect(within(bonusDialog).queryByText('Markets')).not.toBeInTheDocument();
    expect(within(bonusDialog).queryByText('Rests')).not.toBeInTheDocument();
    ...
    const fortSterlingRowText = within(bonusDialog).getByRole('heading', { name: 'Fort Sterling' }).closest('section').textContent;
    expect(fortSterlingRowText.indexOf('Raw Chicken')).toBeLessThan(fortSterlingRowText.indexOf('Hammer'));
    expect(fortSterlingRowText.indexOf('Hammer')).toBeLessThan(fortSterlingRowText.indexOf('Cloth Armor'));
    expect(fortSterlingRowText.indexOf('Cloth Armor')).toBeLessThan(fortSterlingRowText.indexOf('Plate Helmet'));
    ...
    expect(screen.getByRole('dialog', { name: 'Crafting Bonuses' })).toBeInTheDocument();
